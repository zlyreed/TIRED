...
%% Testing No is from 1 to 21 (subject No. is from 2 to 22)
currentDir=pwd();
[ndata, text, rawData_cell] = xlsread('SubjectInfo_ForceRPE_all.xlsx');
...
save('ForceCell_total.mat','Force_Cell','-v7.3')
