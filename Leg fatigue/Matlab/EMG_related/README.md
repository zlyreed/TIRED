  ...
  - Summary (total 7 channels): 
    ...
    - Missing data: 
	   ...
	   - Test No 5 (S8): Channel 1 was not good after MVC30_fatigue 1 and MVC100_1; for those trials, use Channel 6 recording for Rectus Femoris. 
	      - fixed Test No. 5 (updated at '...\LegFatigueTesting05_2017-09-15_S08\Vicon_Matlab' on 4/5/4019): move the recording from Channel 6 to Channel 2, replace Channel 6 with zeros (use [Fix_EMG_Channels.m](Fix_EMG_Channels.m), which calls [fixArrayColumn.m](fixArrayColumn.m) and [fixCellColumn.m](fixCellColumn.m)). 
