...
for testN=12:21
    ...
    for tn=1:size(TrialList,2)
        ...
        qrs_pos0= jqrs(ECG,Fs,0.5,0.250,0);
        qrs_pos = qrs_adjust(ECG,qrs_pos0,Fs,1,0.050,1); % Make sure the positive peaks are selected!
        ...
        title(['Subject ' num2str(SubjectNo) ' - ' TrialName],'Interpreter', 'none');
        ...
        picNamewTrial=['Subject' num2str(SubjectNo) '_' TrialName]; % picture name
